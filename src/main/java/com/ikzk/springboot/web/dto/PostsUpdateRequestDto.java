...
public class PostsUpdateRequestDto {
    ...
    public static class PostsUpdateRequestDtoBuilder {
        ...
        public PostsUpdateRequestDtoBuilder title(String title) {
            this.title = title;
            return this;
        }

        public PostsUpdateRequestDtoBuilder content(String content) {
            this.content = content;
            return this;
        }
        ...
        public String toString() {
            return "PostsUpdateRequestDto.PostsUpdateRequestDtoBuilder(title=" + this.title + ", content=" + this.content + ")";
        }
    }
}
